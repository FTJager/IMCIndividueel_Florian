...
void timer_100_ms_callback(TimerHandle_t xTimer)
{
    ...
    else if (data > 50)
    {
    ...
    else{       //Check for button presses here

        uint8_t dataButton = 5;     //Default value 5, since 5 is nothing
        RotaryEncoder_getStatus(&dataButton);
        ...
        if (dataButton == 7)
        {
            ...
            RotaryEncoder_setColorGrn(255);
            RotaryEncoder_setColorBlu(0);
